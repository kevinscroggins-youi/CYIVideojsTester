...
CYIVideojsVideoPlayer.prototype.initialize = function initialize(name) {
    ...
    if(self.verbose) {
        console.log("Initializing " + CYIVideojsVideoPlayer.getType() + " player #" + self.id + "...");
    }

    if(self.player) {
        if(self.verbose) {
            console.log(CYIVideojsVideoPlayer.getType() + " player #" + self.id + " already initialized!");
        }
    ...
    self.video.id = "videojs_player_" + self.id;
